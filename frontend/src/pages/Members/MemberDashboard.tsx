                        ...
                        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-5 md:p-8">
                            ...
                            <Card x-chunk="dashboard-01-chunk-4">
                                ...
                                <CardDescription className="max-w-lg text-balance leading-relaxed">
                                    Create a new payment for HOA members to pay.
                                </CardDescription>
                            ...
                            >
                                ...
                                <Table>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                        <div className="font-medium">Blk 24 Lt 1</div>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                        <div className="font-medium"> Blk 3 Lt 4</div>
                                        <div className="hidden text-sm text-muted-foreground md:inline">
                                            04-12-2024
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                        <div className="font-medium">Blk 6 Lt 29</div>
                                        <div className="hidden text-sm text-muted-foreground md:inline">
                                            04-10-2024
