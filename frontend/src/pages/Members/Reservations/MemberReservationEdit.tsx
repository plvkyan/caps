...
export function MemberReservationEditForm() {
    ...
    useEffect(() => {
        ...
        const fetchReservations = async () => {
            ...
            const response = await fetch('http://localhost:4000/api/reservations/details/' + reservations._id)
    ...
    const form = useForm<zod.infer<typeof formSchema>>({
        ...
        defaultValues: {
            blkLt: reservations.blkLt,
            blkLtPosition: reservations.position,
            amenityAddress: reservations.amenityAddress,
            amenityName: reservations.amenityName,
            amenityType: reservations.amenityType,
            reservationQuantity: reservations.reservationQuantity,
            reservationStatus: reservations.reservationStatus,
            reservationReason: reservations.reservationReason,
            stat: reservations.stat
        }
    ...
    const handleSubmit = async (values: zod.infer<typeof formSchema>) => {
        ...
        reset({
            amenityAddress: values.amenityAddress,
            amenityName: values.amenityName,
            amenityType: values.amenityType,
            reservationQuantity: values.reservationQuantity,
            reservationReason: values.reservationReason,
        })
        ...
        if (response.ok) {
            ...
            toast({
                ...
                description: values.amenityName + " reserved at: " + format(values.reservationDate, "PPP"),
                                                    ...
                                                    <div className="mx-auto grid max-w-[70rem] flex-1 auto-rows-max gap-4">
                                                        ...
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <Button variant="outline" size="icon" className="h-7 w-7">
                                                                ...
                                                                <Link to="/member/reservations"> <ChevronLeft className="h-4 w-4" /> </Link>
                                                            ...
                                                            <div className="hidden items-center gap-2 md:ml-auto md:flex">
                                                                ...
                                                                <Button size="sm" type="submit" id="reservationForm"> Confirm Edit </Button>
                                                        ...
                                                        <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
                                                            ...
                                                            <div className="grid items-start gap-2">
                                                                    ...
                                                                    <CardContent className="p-6 text-sm">
                                                                        ...
                                                                        <div className="grid gap-3">
                                                                            ...
                                                                            <ul className="grid gap-3">
                                                                                ...
                                                                                <li className="flex items-center justify-between">
                                                                                    ...
                                                                                    <span className="text-end"> {form.getValues("amenityType")} </span>
                                                                                ...
                                                                                <li className="flex items-center justify-between">
                                                                                    ...
                                                                                    <span className="text-end"> {form.getValues("amenityName")} </span>
                                                                        ...
                                                                        <div className="grid gap-3">
                                                                            ...
                                                                            <ul className="grid gap-3">
                                                                                ...
                                                                                <li className="flex items-center justify-between">
                                                                                    ...
                                                                                    {form.getValues("reservationDate") != null &&
                                                                                        (
                                                                                            ...
                                                                                            <span className="text-end"> {format(form.getValues("reservationDate").toString(), "PPP")} </span>
                                                                                ...
                                                                                <span className="text-muted-foreground text-xs text-end"> All reservations are limited to 24 hours. </span>
                                                                ...
                                                                <span className="px-2 text-muted-foreground text-xs text-end"> This is how your reservation would look like to the admins. </span>
