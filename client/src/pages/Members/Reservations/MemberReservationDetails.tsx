...
export const MemberReservationDetails = ({ reservations }) => {
    ...
    const deleteReservation = async () => {
        ...
        if (response.ok) {
            ...
            window.location.assign("/member/reservations")
        }
    ...
    const routeChange = () => {
        ...
        const path = '/member/reservations/details/edit/' + reservations._id
        navigate(path)
                        ...
                        <CardHeader className="flex flex-row items-start bg-muted/50">
                            ...
                            <div className="grid gap-0.5">
                                ...
                                <CardDescription>
                                    ...
                                    {formatDistanceToNow(new Date(reservations.createdAt), { addSuffix: true })}
                            ...
                            <div className="ml-auto flex items-center gap-1">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        ...
                                        <DropdownMenuItem onClick={routeChange}> Edit </DropdownMenuItem>
                                        <DropdownMenuSeparator />
                                        <DropdownMenuItem onClick={() => setShowDeleteDialog(true)} className="text-destructive"> Delete </DropdownMenuItem>
